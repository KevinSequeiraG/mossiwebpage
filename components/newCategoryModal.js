            ...
            <div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col w-4/5 mx-auto mt-8">
                    <div className='flex justify-between my-2'>
                        ...
                        <input className='rounded' type="text" placeholder="Nombre" {...register("categoryName", { required: true, maxLength: 80 })} />
                    </div>
                    <div className='flex justify-between my-2'>
                        <label className='text-white'>Descripción de categoría</label>
                        <input className='rounded' type="textarea" placeholder="Descripción" {...register("categoryDescription", { required: true, maxLength: 100 })} />
                    </div>
